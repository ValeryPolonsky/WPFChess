...
namespace WPFChess
{
    class Rook:Figure
    {
        public Rook(int color, string row, string column, int game_direction): base(color, Globals.figure_rook, row, column, game_direction)
        {
        ...
        protected override void setFigureImage()
        {
            ...
            if(color==Globals.color_black)
                image_source = Globals.figures_images_path + "black_rook.png";
            else
                image_source = Globals.figures_images_path + "white_rook.png";
